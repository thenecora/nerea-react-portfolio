...
const NavigationContainer = (props) => {
        ...
        return (
           ...
           </div> // hemos añadido un ternary operator para que el botón se muestre solo si quien inicia sesión es admin. Esto lo hemos hecho hard-coded, pero cuando haya un bloque de Autorización, esto se herá de forma dinámica
        )
    }
